...
class UpdateEmployeeComponent extends Component {
    ...
    updateEmployee = (e) => {
        e.preventDefault();
        let employee = {id:this.state.id,firstName: this.state.firstName, lastName: this.state.lastName, emailId: this.state.emailId, salary: this.state.salary};
                                    ...
                                    <form>
                                        <div className = "form-group">
                                            ...
                                            <input placeholder="Employee Id" name="employeeId" className="form-control" 
                                                value={this.state.id} onChange={this.changeEmployeeIdHandler}/>
                                        </div>
